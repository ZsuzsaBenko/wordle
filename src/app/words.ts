export const WORDS = {
    ...
    'F': [
        ...
        'FÁZIK', 'FÁZIS', 'FÁZÓS', 'FECNI', 'FEDDŐ', 'FEDEZ', 'FEDÉL', 'FEDÉS', 'FEHÉR', 'FEJEL', 'FEJES', 'FEJÉK', 'FEJÉS', 'FEJFA',
        'FEKVŐ', 'FELAD', 'FELÁR', 'FELÁS', 'FELED', 'FELEL', 'FELES', 'FELEZ', 'FELÉG', 'FELÉL', 'FELÉR', 'FELHŐ', 'FELÍR', 'FELLŐ',
        'FELNŐ', 'FELŐL', 'FELRÓ', 'FELSŐ', 'FELÜL', 'FELÜT', 'FENÉK', 'FENÉS', 'FENOL', 'FENTI', 'FENYŐ', 'FERDE', 'FERTŐ', 'FESTŐ',
        'FÉKEZ', 'FÉKÚT', 'FÉLBE', 'FÉLÉV', 'FÉLIG', 'FÉLŐS', 'FÉLRE', 'FÉLSZ', 'FÉLTŐ', 'FÉMES', 'FÉREG', 'FÉRFI', 'FÉSÜL', 'FÉTIS',
        'FICAM', 'FICKÓ', 'FIKÁS', 'FIKÁZ', 'FILÉZ', 'FINIS', 'FINOM', 'FIOLA', 'FIÓKA', 'FIRKA', 'FIRMA', 'FITOS', 'FITTY', 'FIVÉR',
        'FIXÁL', 'FIZET', 'FLANC', 'FLEKK', 'FLÓRA', 'FLOTT', 'FLÖRT', 'FLUOR', 'FODOR', 'FOGAD', 'FOGAN', 'FOGAS', 'FOGAT', 'FOGÁS',
        'FOGDA', 'FOGKŐ', 'FOGÓS', 'FOGVA', 'FOGYÓ', 'FOJTÓ', 'FOKOS', 'FOKOZ', 'FOLYÓ', 'FONAL', 'FONAT', 'FONÁK', 'FONÁL', 'FONÁS',
        'FONDÜ', 'FORGÓ', 'FORMA', 'FOROG', 'FORRÓ', 'FOSÁS', 'FOSIK', 'FOTEL', 'FOTON', 'FOTÓS', 'FOTÓZ', 'FÓBIA', 'FÓLIA', 'FÓRUM',
        'FÖDÉM', 'FÖLDI', 'FÖLÖS', 'FÖLÖZ', 'FÖLSŐ', 'FÖLÜL', 'FÖNTI', 'FŐCÍM', 'FŐDÍJ', 'FŐFAL', 'FŐHŐS', 'FŐIGE', 'FŐLEG', 'FŐNÉV',
        'FŐNIX', 'FŐNÖK', 'FŐNÖZ', 'FŐPAP', 'FŐTÉR', 'FŐÚRI', 'FŐZET', 'FŐZÉS', 'FRAKK', 'FRANC', 'FRANK', 'FRÁSZ', 'FREON', 'FRIGY',
        'FRISS', 'FRONT', 'FUCCS', 'FUKAR', 'FÜGÉS', 'FÜGGŐ', 'FUGÁZ', 'FUNKY', 'FURAT', 'FUTAM', 'FUTÁR', 'FUTÁS', 'FUVAR', 'FÚJÁS',
        'FÚRÁS', 'FÚRIA', 'FÚVÓS', 'FÚZIÓ', 'FÜGGŐ', 'FÜLEL', 'FÜLES', 'FÜLKE', 'FÜLTŐ', 'FÜRDŐ', 'FÜRGE', 'FÜRDŐ', 'FÜRGE', 'FÜTYI',
        'FÜTTY', 'FÜVES', 'FÜZET', 'FÜZÉR', 'FŰEVŐ', 'FŰLIK', 'FŰMAG', 'FŰTÉS', 'FŰZÁG', 'FŰZÉS', 'FŰZFA', 'FŰZŐS'
    ],
    'G': [
    ...
    'K': [
        ...
        'KANÜL', 'KAPAR', 'KAPÁL', 'KAPÁS', 'KAPCA', 'KAPOR', 'KAPÓS', 'KAPUS', 'KARAJ', 'KARÁM', 'KARÁT', 'KARÉJ', 'KARFA', 'KARMA',
        'KAROL', 'KAROM', 'KARÓS', 'KARÓZ', 'KARTA', 'KASPÓ', 'KASZA', 'KASZT', 'KATÓD', 'KAVAR', 'KAZAH', 'KAZAL', 'KAZÁN', 'KÁBEL',
        'KÁBÍT', 'KÁBUL', 'KÁDAS', 'KÁDÁR', 'KÁDER', 'KÁNON', 'KÁNYA', 'KÁOSZ', 'KÁROG', 'KÁROS', 'KÁSÁS', 'KÁTYÚ', 'KÁVÉS', 'KEBEL',
        'KEDDI', 'KEFÉL', 'KEFÍR', 'KEKSZ', 'KELET', 'KELÉS', 'KELLŐ', 'KELME', 'KELTA', 'KELTŐ', 'KENCE', 'KENDŐ', 'KENET', 'KENÉS',
        'KEREK', 'KERES', 'KERET', 'KERÉK', 'KERGE', 'KERÍT', 'KERTI', 'KERUB', 'KERÜL', 'KETTÉ', 'KETTŐ', 'KEVER', 'KEVÉS', 'KEZDŐ',
        'KEZEL', 'KEZES', 'KEZEZ', 'KÉGLI', 'KÉJES', 'KÉJNŐ', 'KÉKES', 'KÉKÍT', 'KÉKÜL', 'KÉMIA', 'KÉMNŐ', 'KÉNES', 'KÉNEZ', 'KÉNKŐ',
        'KÉPES', 'KÉPEZ', 'KÉPZŐ', 'KÉRDŐ', 'KÉREG', 'KÉREM', 'KÉRET', 'KÉRÉS', 'KÉSEI', 'KÉSEL', 'KÉSES', 'KÉSÉS', 'KÉSIK', 'KÉSŐI',
        'KÉSŐN', 'KÉTES', 'KHAKI', 'KIADÓ', 'KIÁLL', 'KIÁLT', 'KIBIC', 'KIBÍR', 'KIBÖK', 'KIBUC', 'KICSI', 'KIDOB', 'KIDŐL', 'KIDUG',
        'KIEJT', 'KIÉLT', 'KIFED', 'KIFEJ', 'KIFEN', 'KIFÉR', 'KIFLI', 'KIFOG', 'KIFŐZ', 'KIFUT', 'KIFÚJ', 'KIFÚR', 'KIFŰT', 'KIFŰZ',
        'KIHAL', 'KIHAT', 'KIHÍV', 'KIHOZ', 'KIHÚZ', 'KIHŰL', 'KIHŰT', 'KIIRT', 'KIJÁR', 'KIJÖN', 'KIJUT', 'KIKAP', 'KIKEL', 'KIKEN',
        'KIKÉR', 'KIKÖP', 'KIKÖT', 'KILÁT', 'KILEL', 'KILES', 'KILÉP', 'KILÉT', 'KILOP', 'KILÓG', 'KILÖK', 'KIMAR', 'KIMER', 'KIMÉR',
        'KIMOS', 'KINCS', 'KINÉZ', 'KINCS', 'KININ', 'KINTI', 'KIOLD', 'KIOLT', 'KIONT', 'KIÖLT', 'KIÖNT', 'KISÍR', 'KIRAK', 'KIRÁG',
        'KIRÁZ', 'KIRÚG', 'KISÍR', 'KISSÉ', 'KISÜL', 'KISÜT', 'KITÁR', 'KITÁT', 'KITÉP', 'KITÉR', 'KITIN', 'KITOL', 'KITÖM', 'KITÖR',
        'KITÚR', 'KITŰZ', 'KIVAN', 'KIVÁG', 'KIVÁJ', 'KIVÁR', 'KIVER', 'KIVET', 'KIVÉD', 'KIVÉS', 'KIVÉT', 'KIVÍV', 'KIVON', 'KIZÁR',
        'KÍGYÓ', 'KÍNAI', 'KÍNÁL', 'KÍNOS', 'KÍNOZ', 'KÍNZÓ', 'KÍSÉR', 'KÍVÁN', 'KÍVÜL', 'KLIKK', 'KLISÉ', 'KLÍMA', 'KOALA', 'KOBAK',
        'KOCKA', 'KOCOG', 'KOCSI', 'KOMÁZ', 'KOMBI', 'KOMLÓ', 'KOMOR', 'KOMÓD', 'KONDA', 'KONDI', 'KONGA', 'KONOK', 'KONTY', 'KOPÁR',
        'KOPÁS', 'KOPIK', 'KOPOG', 'KORAI', 'KORÁL', 'KORÁN', 'KORCS', 'KORDÉ', 'KORHŰ', 'KOROG', 'KOROM', 'KOROS', 'KORPA', 'KORSÓ',
        'KORTY', 'KORZÓ', 'KOSÁR', 'KOSZT', 'KOTON', 'KOTOR', 'KOTTA', 'KOZÁK', 'KÓBOR', 'KÓCOL', 'KÓCOS', 'KÓDEX', 'KÓDOL', 'KÓKAD',
        'KÓMÁS', 'KÓPIA', 'KÓROS', 'KÓRUS', 'KÓSER', 'KÓSZA', 'KÖDÖL', 'KÖDÖS', 'KÖHÖG', 'KÖLES', 'KÖLNI', 'KÖLTŐ', 'KÖNNY', 'KÖNYV',
        'KÖPET', 'KÖPÉS', 'KÖPÜL', 'KÖRBE', 'KÖRET', 'KÖRÍT', 'KÖRÍV', 'KÖRÖM', 'KÖRÖZ', 'KÖRTE', 'KÖRÚT', 'KÖRÜL', 'KÖRZŐ', 'KÖSZI',
        'KÖTEG', 'KÖTET', 'KÖTÉL', 'KÖTÉS', 'KÖTÖZ', 'KÖTVE', 'KÖVES', 'KÖVET', 'KÖVEZ', 'KÖVÉR', 'KÖZBE', 'KÖZEG', 'KÖZEL', 'KÖZÉP',
        'KÖZJÓ', 'KÖZMŰ', 'KÖZÖL', 'KÖZÖS', 'KÖZTE', 'KÖZTI', 'KÖZÚT', 'KÖZÜL', 'KŐFAL', 'KŐKOR', 'KŐLAP', 'KŐPOR', 'KŐZET', 'KRACH',
        'KREÁL', 'KREOL', 'KREPP', 'KRESZ', 'KRÉTA', 'KRIMI', 'KROKI', 'KUCKÓ', 'KUFÁR', 'KUGLI', 'KUJON', 'KUKAC', 'KUKÁS', 'KUKÁZ',
        'KUKTA', 'KULÁK', 'KULCS', 'KUPAC', 'KUPAK', 'KUPEC', 'KUPLÉ', 'KUPON', 'KURTA', 'KURUC', 'KUSZA', 'KUTAS', 'KUTAT', 'KUTYA',
        'KUVIK', 'KÚPOS', 'KÚRÁL', 'KÚRIA', 'KÚTFŐ', 'KÜBLI', 'KÜLDŐ', 'KÜLLŐ', 'KÜLÖN', 'KÜLSŐ', 'KÜRTŐ', 'KÜTYÜ', 'KÜZDŐ', 'KVARC',
        'KVARK', 'KVINT', 'KVITT', 'KVÓTA'
    ],
    'L': [
    ...
    'M': [
        ...
        'MAKOG', 'MAKRÓ', 'MALAC', 'MALOM', 'MALŐR', 'MAMBA', 'MAMBÓ', 'MAMUT', 'MANCS', 'MANGÓ', 'MANKÓ', 'MANNA', 'MAPPA', 'MARAD',
        'MARAT', 'MARÁS', 'MARÉK', 'MARGÓ', 'MARHA', 'MAROK', 'MASNI', 'MASZK', 'MATAT', 'MATEK', 'MATYÓ', 'MÁGIA', 'MÁGUS', 'MÁJAS',
        'MÁJUS', 'MÁKOS', 'MÁLHA', 'MÁLNA', 'MÁMOR', 'MÁNIA', 'MÁRGA', 'MÁRIS', 'MÁRKA', 'MÁRKI', 'MÁRNA', 'MÁSIK', 'MÁSOK', 'MÁSOL',
        'MÁTKA', 'MÁZAS', 'MÁZAZ', 'MÁZLI', 'MÁZOL', 'MÁZSA', 'MECCS', 'MEDÁL', 'MEDDŐ', 'MEDER', 'MEDVE', 'MEGAD', 'MEGÁS', 'MEGÉG',
        'MEGÉL', 'MEGÉR', 'MEGFŐ', 'MEGGY', 'MEGÍR', 'MEGLŐ', 'MEGNŐ', 'MEGÓV', 'MEGÖL', 'MEGRÓ', 'MEGUN', 'MEGÜL', 'MEGÜT', 'MEGYE',
        'MEKEG', 'MELÁK', 'MELEG', 'MELLÉ', 'MELÓS', 'MENÁD', 'MENET', 'MENÉS', 'MENNY', 'MENTA', 'MENTE', 'MENTŐ', 'MENZA', 'MERED',
        'MEREV', 'MERÍT', 'MERRE', 'MERSZ', 'MERÜL', 'MESÉL', 'MESÉS', 'METÁN', 'METÉL', 'METRÓ', 'METSZ', 'MEZEI', 'MÉDIA', 'MÉGIS',
        'MÉGSE', 'MÉHES', 'MÉLÁZ', 'MÉLTÓ', 'MÉNES', 'MÉNKŰ', 'MÉRCE', 'MÉREG', 'MÉRET', 'MÉRÉS', 'MÉTER', 'MÉZES', 'MÉZEZ', 'MÉZGA',
        'MIATT', 'MINTA', 'MIDŐN', 'MIENK', 'MIÉNK', 'MIÉRT', 'MIKOR', 'MIKRÓ', 'MINAP', 'MINEK', 'MINÉL', 'MINTA', 'MIÓMA', 'MIÓTA',
        'MIRHA', 'MIVEL', 'MIXER', 'MILIŐ', 'MÍDER', 'MÍMEL', 'MÍVES', 'MOBIL', 'MODEM', 'MODOR', 'MODUL', 'MOGUL', 'MOHÁS', 'MOHOS',
        'MOHÓN', 'MOKKA', 'MONÁD', 'MONDA', 'MOPED', 'MORAJ', 'MORÁL', 'MOROG', 'MORVA', 'MORZE', 'MOSAT', 'MOSÁS', 'MOSDÓ', 'MOTEL',
        'MOTOR', 'MOTOZ', 'MOTTÓ', 'MOTYÓ', 'MOZGÓ', 'MOZOG', 'MÓDOS', 'MÓKÁS', 'MÓKUS', 'MÓRES', 'MÖGÜL', 'MUFTI', 'MULAT', 'MULTI',
        'MULYA', 'MUMUS', 'MUNGÓ', 'MUNKA', 'MURCI', 'MURIS', 'MURVA', 'MUTAT', 'MUTÁL', 'MUTYI', 'MÚLÁS', 'MÚLIK', 'MÚLVA', 'MÚMIA',
        'MÚZSA', 'MÜZLI', 'MŰBŐR', 'MŰDAL', 'MŰFAJ', 'MŰFOG', 'MŰJÉG', 'MŰLÁB', 'MŰNEM', 'MŰSOR', 'MŰTÉT', 'MŰTŐS', 'MŰSZÓ', 'MŰTÉT',
        'MŰTŐS', 'MŰVEK', 'MŰVEL'
    ],
    'N': [
